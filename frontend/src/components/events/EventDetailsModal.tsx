...
import { Calendar, Clock, Download, ExternalLink, MapPin, Users, X } from "lucide-react";
...
const EventDetailsModal: React.FC<EventDetailsModalProps> = ({ event, onClose, getEventTypeColor }) => {
  return (
              ...
              {event.speakers.map((speaker, index) => (
                <div key={index} className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                  <div className="flex items-start">
                    <img src={speaker.image} alt={speaker.name} className="w-16 h-16 rounded-full object-cover mr-4" />
                    <div>
